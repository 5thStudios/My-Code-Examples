...
In essense, we are using Umbraco as a centralized data storage between both the website and the api that will be managed within the business layer.

*Note: the api project is not built yet.  This will be programmed after the main website is completed.