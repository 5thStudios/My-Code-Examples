...
namespace www.Controllers
{
    public class ContactUsPageController : RenderController
    {
        ...
        private readonly ILogger<ContactUsPageController> logger;
        ...
        public ContactUsPageController(
                ILogger<ContactUsPageController> _logger,
        ...
        {
            //
            var cmPage = new ContactUsPage(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContactUsPage, ContactUsPageViewModel>
            {
                Page = cmPage,
                ViewModel = new ContactUsPageViewModel()
            };

            return View(Common.View.ContactUsPage, viewModel);
        }
    }
}
