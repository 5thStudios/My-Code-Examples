...
{
    public class NewsCategoryScholarsController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsCategoryScholarsController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;
        private readonly IPublishedContentQuery publishedContentQuery;

        public NewsCategoryScholarsController(
                ILogger<NewsCategoryScholarsController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new NewsCategoryScholars(CurrentPage, _publishedValueFallback);
            var cmParent = new NewsLattusScholars(CurrentPage.Parent, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.NewsCategoryScholars, NewsListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            return View(Common.View.NewsCategoryScholars, viewModel);
        }
