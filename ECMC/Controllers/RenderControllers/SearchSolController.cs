...
{
    public class SearchSolController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<SearchSolController> logger;
        private readonly IPublishedContentQuery publishedContentQuery;

        public SearchSolController(
                ILogger<SearchSolController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new ContentModels.SearchSol(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.SearchSol, List<SearchResultViewModel>>
            {
                Page = cmPage,
                ViewModel = lstSearchResults
            };

            return View(Common.View.SearchSol, viewModel);
        }
    }
}
