...
{
    public class ListLattusFndController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<ListLattusFndController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;

        public ListLattusFndController(
                ILogger<ListLattusFndController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new ListLattusFnd(CurrentPage, _publishedValueFallback);
            ...
            try
            {
                ...
                if (cmPage.Children.Any())
                {
                    foreach (var ipChild in cmPage.Children)
                    {
                        ...
                        {
                            case Common.Doctype.PartnerCardFnd:
                                item = RenderCard_PartnerLandingPg(ipChild);
                                break;


                            case Common.Doctype.PersonLandingPageFnd:
                                item = RenderCard_PersonLandingPg(ipChild);
                                break;


                            case Common.Doctype.DocumentCardFnd:
                                item = RenderCard_DocumentLandingPg(ipChild);
                                break;


                            case Common.Doctype.NewsAndEventsLandingPageFnd:
                                item = RenderCard_NewsAndEventsLandingPg(ipChild);
                                break;


                            case Common.Doctype.IconCardCompFnd:
            ...
            var viewModel = new ComposedPageViewModel<ListLattusFnd, ListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };

            return View(Common.View.ListLattusFnd, viewModel);
        }
        ...
        private ListItemViewModel RenderCard_PartnerLandingPg(IPublishedContent ipChild)
        {
            ...
            ContentModels.PartnerCardFnd cmPartnerLattice = new ContentModels.PartnerCardFnd(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_DocumentLandingPg(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.DocumentCardFnd cmDocumentLanding = new ContentModels.DocumentCardFnd(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_NewsAndEventsLandingPg(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.NewsAndEventsLandingPageFnd cmNewsAndEventsLandingPage = new ContentModels.NewsAndEventsLandingPageFnd(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_IconCard(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.IconCardCompFnd cmItem = new ContentModels.IconCardCompFnd(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
