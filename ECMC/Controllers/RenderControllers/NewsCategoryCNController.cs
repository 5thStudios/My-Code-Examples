...
{
    public class NewsCategoryCNController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsCategoryCNController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;
        private readonly IPublishedContentQuery publishedContentQuery;

        public NewsCategoryCNController(
                ILogger<NewsCategoryCNController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new NewsCategoryCN(CurrentPage, _publishedValueFallback);
            var cmParent = new NewsLattusCN(CurrentPage.Parent, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.NewsCategoryCN, NewsListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            return View(Common.View.NewsCategoryCN, viewModel);
        }
