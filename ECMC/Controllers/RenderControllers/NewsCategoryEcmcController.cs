...
{
    public class NewsCategoryEcmcController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsCategoryEcmcController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;
        private readonly IPublishedContentQuery publishedContentQuery;

        public NewsCategoryEcmcController(
                ILogger<NewsCategoryEcmcController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new NewsCategoryEcmc(CurrentPage, _publishedValueFallback);
            var cmParent = new NewsLattusEcmc(CurrentPage.Parent, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.NewsCategoryEcmc, NewsListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            return View(Common.View.NewsCategoryEcmc, viewModel);
        }
