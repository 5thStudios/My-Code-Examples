...
{
    public class PersonLandingPageARController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<PersonLandingPageARController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;

        public PersonLandingPageARController(
                ILogger<PersonLandingPageARController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new PersonLandingPageAR(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<PersonLandingPageAR, PersonLandingPgViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };

            return View(Common.View.PersonLandingPageAR, viewModel);
        }
    }
}
