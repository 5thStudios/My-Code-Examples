...
{
    public class NewsLattusQTQController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsLattusQTQController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;
        private readonly IPublishedContentQuery publishedContentQuery;

        public NewsLattusQTQController(
                ILogger<NewsLattusQTQController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new NewsLattusQtq(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.NewsLattusQtq, NewsListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            return View(Common.View.NewsLattusQTQ, viewModel);
        }
