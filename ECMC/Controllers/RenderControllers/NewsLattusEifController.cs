...
{
    public class NewsLattusEifController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsLattusEifController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;
        private readonly IPublishedContentQuery publishedContentQuery;

        public NewsLattusEifController(
                ILogger<NewsLattusEifController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new NewsLattusEif(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.NewsLattusEif, NewsListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            return View(Common.View.NewsLattusEIF, viewModel);
        }
