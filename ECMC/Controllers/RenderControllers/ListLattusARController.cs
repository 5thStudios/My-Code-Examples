...
{
    public class ListLattusARController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<ListLattusARController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;

        public ListLattusARController(
                ILogger<ListLattusARController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new ListLattusAR(CurrentPage, _publishedValueFallback);
            ...
            try
            {
                ...
                if (cmPage.Children.Any())
                {
                    foreach (var ipChild in cmPage.Children)
                    {
                        ...
                        {
                            case Common.Doctype.PartnerCardAR:
                                item = RenderCard_PartnerLandingPg(ipChild);
                                break;


                            case Common.Doctype.PersonLandingPageAR:
                                item = RenderCard_PersonLandingPg(ipChild);
                                break;


                            case Common.Doctype.DocumentCardAR:
                                item = RenderCard_DocumentLandingPg(ipChild);
                                break;


                            case Common.Doctype.NewsAndEventsLandingPageAR:
                                item = RenderCard_NewsAndEventsLandingPg(ipChild);
                                break;


                            case Common.Doctype.IconCardCompAR:
            ...
            var viewModel = new ComposedPageViewModel<ListLattusAR, ListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };

            return View(Common.View.ListLattusAR, viewModel);
        }
        ...
        private ListItemViewModel RenderCard_PartnerLandingPg(IPublishedContent ipChild)
        {
            ...
            ContentModels.PartnerCardAR cmPartnerLattice = new ContentModels.PartnerCardAR(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_PersonLandingPg(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.PersonLandingPageAR cmPersonLandingPg = new ContentModels.PersonLandingPageAR(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_DocumentLandingPg(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.DocumentCardAR cmDocumentLanding = new ContentModels.DocumentCardAR(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_NewsAndEventsLandingPg(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.NewsAndEventsLandingPageAR cmNewsAndEventsLandingPage = new ContentModels.NewsAndEventsLandingPageAR(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_IconCard(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.IconCardCompAR cmItem = new ContentModels.IconCardCompAR(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
