...
{
    public class NewsAndEventsLandingPageEGController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsAndEventsLandingPageEGController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;

        public NewsAndEventsLandingPageEGController(
                ILogger<NewsAndEventsLandingPageEGController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            ContentModels.NewsAndEventsLandingPageEG cmPage = new ContentModels.NewsAndEventsLandingPageEG(CurrentPage, _publishedValueFallback);
            ...
            {
                //Instantiate variableas
                ContentModels.ListLattusEG cmListLattusEG = new ListLattusEG(cmPage.Parent, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
                ...
                if (cmPage.Parent!.Children.Any())
                {
                    foreach (var ipChild in cmPage.Parent.Children)
                    {
                        ...
                        ContentModels.NewsAndEventsLandingPageEG cmNewsAndEventsLandingPg = new ContentModels.NewsAndEventsLandingPageEG(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
            ...
            var viewModel = new ComposedPageViewModel<NewsAndEventsLandingPageEG, NewsAndEventsLandingPgViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            //return null;
            return View(Common.View.NewsAndEventsLandingPageEG, viewModel);
        }
    }
}
