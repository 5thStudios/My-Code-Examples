...
{
    public class ListLattusEifController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<ListLattusEifController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;

        public ListLattusEifController(
                ILogger<ListLattusEifController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new ListLattusEif(CurrentPage, _publishedValueFallback);
            ...
            try
            {
                ...
                if (cmPage.Children.Any())
                {
                    foreach (var ipChild in cmPage.Children)
                    {
                        ...
                        {
                            case Common.Doctype.PartnerCardEIF:
                                item = RenderCard_PartnerLandingPg(ipChild);
                                break;


                            case Common.Doctype.PersonLandingPageEIF:
                                item = RenderCard_PersonLandingPg(ipChild);
                                break;


                            case Common.Doctype.DocumentCardEIF:
                                item = RenderCard_DocumentLandingPg(ipChild);
                                break;


                            case Common.Doctype.NewsAndEventsLandingPageEIF:
                                item = RenderCard_NewsAndEventsLandingPg(ipChild);
                                break;


                            case Common.Doctype.IconCardCompEIF:
            ...
            var viewModel = new ComposedPageViewModel<ListLattusEif, ListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };

            return View(Common.View.ListLattusEIF, viewModel);
        }
        ...
        private ListItemViewModel RenderCard_PartnerLandingPg(IPublishedContent ipChild)
        {
            ...
            ContentModels.PartnerCardEif cmPartnerLattice = new ContentModels.PartnerCardEif(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_PersonLandingPg(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.PersonLandingPageEif cmPersonLandingPg = new ContentModels.PersonLandingPageEif(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_DocumentLandingPg(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.DocumentCardEif cmDocumentLanding = new ContentModels.DocumentCardEif(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_NewsAndEventsLandingPg(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.NewsAndEventsLandingPageEif cmNewsAndEventsLandingPage = new ContentModels.NewsAndEventsLandingPageEif(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        private ListItemViewModel RenderCard_IconCard(IPublishedContent ipChild)
        {
            ...
            //Obtain model vsn of child node
            ContentModels.IconCardCompEif cmItem = new ContentModels.IconCardCompEif(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
        ...
        //private ListItemViewModel RenderCard_FullWidthImg(IPublishedContent ipChild)
        //{
        //    //Instantiate variables
        //    ListItemViewModel item = new ListItemViewModel();

        //    //Obtain model vsn of child node
        //    ContentModels.FullWidthImageCardComp cmItem = new ContentModels.FullWidthImageCardComp(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));

        //    //Obtain all data from model
        //    item.DocType = cmItem.ContentType.Alias;
        //    item.FullWidthImageCard = new FullWidthImageCard(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
