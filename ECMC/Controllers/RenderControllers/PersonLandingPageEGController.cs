...
{
    public class PersonLandingPageEGController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<PersonLandingPageEGController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;

        public PersonLandingPageEGController(
                ILogger<PersonLandingPageEGController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new PersonLandingPageEG(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<PersonLandingPageEG, PersonLandingPgViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };

            return View(Common.View.PersonLandingPageEG, viewModel);
        }
    }
}
