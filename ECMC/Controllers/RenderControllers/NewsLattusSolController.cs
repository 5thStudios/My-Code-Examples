...
{
    public class NewsLattusSolController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsLattusSolController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;
        private readonly IPublishedContentQuery publishedContentQuery;

        public NewsLattusSolController(
                ILogger<NewsLattusSolController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new NewsLattusSol(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.NewsLattusSol, NewsListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            return View(Common.View.NewsLattusSol, viewModel);
        }
