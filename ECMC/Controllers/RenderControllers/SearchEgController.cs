...
{
    public class SearchEgController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<SearchEgController> logger;
        private readonly IPublishedContentQuery publishedContentQuery;

        public SearchEgController(
                ILogger<SearchEgController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new ContentModels.SearchEG(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.SearchEG, List<SearchResultViewModel>>
            {
                Page = cmPage,
                ViewModel = lstSearchResults
            };

            return View(Common.View.SearchEG, viewModel);
        }
    }
}
