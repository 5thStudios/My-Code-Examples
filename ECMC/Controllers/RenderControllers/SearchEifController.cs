...
{
    public class SearchEifController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<SearchEifController> logger;
        private readonly IPublishedContentQuery publishedContentQuery;

        public SearchEifController(
                ILogger<SearchEifController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new ContentModels.SearchEif(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.SearchEif, List<SearchResultViewModel>>
            {
                Page = cmPage,
                ViewModel = lstSearchResults
            };

            return View(Common.View.SearchEIF, viewModel);
        }
    }
}
