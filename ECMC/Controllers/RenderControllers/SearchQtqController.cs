...
{
    public class SearchQtqController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<SearchQtqController> logger;
        private readonly IPublishedContentQuery publishedContentQuery;

        public SearchQtqController(
                ILogger<SearchQtqController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new ContentModels.SearchQtq(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.SearchQtq, List<SearchResultViewModel>>
            {
                Page = cmPage,
                ViewModel = lstSearchResults
            };

            return View(Common.View.SearchQTQ, viewModel);
        }
    }
}
