...
{
    public class NewsCategorySolController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsCategorySolController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;
        private readonly IPublishedContentQuery publishedContentQuery;

        public NewsCategorySolController(
                ILogger<NewsCategorySolController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new NewsCategorySol(CurrentPage, _publishedValueFallback);
            var cmParent = new NewsLattusSol(CurrentPage.Parent, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<ContentModels.NewsCategorySol, NewsListViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            return View(Common.View.NewsCategorySol, viewModel);
        }
