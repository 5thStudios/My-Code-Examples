...
{
    public class PersonLandingPageEIFController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<PersonLandingPageEIFController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;

        public PersonLandingPageEIFController(
                ILogger<PersonLandingPageEIFController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            var cmPage = new PersonLandingPageEif(CurrentPage, _publishedValueFallback);
            ...
            var viewModel = new ComposedPageViewModel<PersonLandingPageEif, PersonLandingPgViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };

            return View(Common.View.PersonLandingPageEIF, viewModel);
        }
    }
}
