...
{
    public class NewsAndEventsLandingPageFndController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsAndEventsLandingPageFndController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;

        public NewsAndEventsLandingPageFndController(
                ILogger<NewsAndEventsLandingPageFndController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            ContentModels.NewsAndEventsLandingPageFnd cmPage = new ContentModels.NewsAndEventsLandingPageFnd(CurrentPage, _publishedValueFallback);
            ...
            try
            {
                ...
                if (cmPage.Parent!.Children.Any())
                {
                    foreach (var ipChild in cmPage.Parent.Children)
                    {
                        ...
                        ContentModels.NewsAndEventsLandingPageFnd cmNewsAndEventsLandingPg = new ContentModels.NewsAndEventsLandingPageFnd(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
            ...
            var viewModel = new ComposedPageViewModel<NewsAndEventsLandingPageFnd, NewsAndEventsLandingPgViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            //return null;
            return View(Common.View.NewsAndEventsLandingPageFnd, viewModel);
        }
    }
}
