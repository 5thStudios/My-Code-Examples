...
{
    public class NewsAndEventsLandingPageEIFController : RenderController
    {
        private IPublishedValueFallback _publishedValueFallback;
        private UmbracoHelper UmbracoHelper;
        private readonly ILogger<NewsAndEventsLandingPageEIFController> logger;
        private readonly ServiceContext _serviceContext;
        private readonly IVariationContextAccessor _variationContextAccessor;

        public NewsAndEventsLandingPageEIFController(
                ILogger<NewsAndEventsLandingPageEIFController> _logger,
        ...
        public override IActionResult Index()
        {
            ...
            ContentModels.NewsAndEventsLandingPageEif cmPage = new ContentModels.NewsAndEventsLandingPageEif(CurrentPage, _publishedValueFallback);
            ...
            {
                //Instantiate variableas
                ContentModels.ListLattusEif cmListLattusEIF = new ListLattusEif(cmPage.Parent, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
                ...
                if (cmPage.Parent!.Children.Any())
                {
                    foreach (var ipChild in cmPage.Parent.Children)
                    {
                        ...
                        ContentModels.NewsAndEventsLandingPageEif cmNewsAndEventsLandingPg = new ContentModels.NewsAndEventsLandingPageEif(ipChild, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
            ...
            var viewModel = new ComposedPageViewModel<NewsAndEventsLandingPageEif, NewsAndEventsLandingPgViewModel>
            {
                Page = cmPage,
                ViewModel = lstVmodel
            };
            ...
            //return null;
            return View(Common.View.NewsAndEventsLandingPageEIF, viewModel);
        }
    }
}
