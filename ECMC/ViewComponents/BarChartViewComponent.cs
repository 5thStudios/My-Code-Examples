...
namespace www.ViewComponents
{
    public class BarChartViewComponent : ViewComponent
    {
        ...
        private readonly ILogger<BarChartViewComponent> logger;


        public BarChartViewComponent(
            ILogger<BarChartViewComponent> _logger,
        ...
        public async Task<IViewComponentResult> InvokeAsync(Umbraco.Cms.Core.Models.Blocks.BlockGridItem<BarChart> Model)
        {
