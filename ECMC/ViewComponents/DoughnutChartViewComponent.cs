...
{
    public class DoughnutChartViewComponent : ViewComponent
    {
        private IUmbracoContextAccessor Context;
        private UmbracoHelper UmbracoHelper;
        private IPublishedValueFallback PublishedValueFallback;
        private readonly IExamineManager ExamineManager;
        private readonly ILogger<DoughnutChartViewComponent> logger;


        public DoughnutChartViewComponent(
            ILogger<DoughnutChartViewComponent> _logger,
        ...
        public async Task<IViewComponentResult> InvokeAsync(Umbraco.Cms.Core.Models.Blocks.BlockGridItem<DoughnutChart> Model)
        {
